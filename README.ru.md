...
| **SFTP** | Встроенный файловый менеджер в каждой сессии: навигация, загрузка (диалог + drag & drop), скачивание, переименование, создание папки, удаление, копирование пути/имени, прогресс передачи |
